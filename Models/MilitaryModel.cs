...
namespace Household_Management_System.Models
{
    ...
    {
        private string identityCode, name, birthDay, ethnic, permanentAddress, status, note;

        public MilitaryModel(string identityCode, string name, string birthDay, string ethnic, string permanentAddress, string status, string note)
        {
