...
namespace Household_Management_System.Models
{
    public class AbsenceModel
    {
        ...
        public AbsenceModel(string absenceName, string identityCode, string birthDay, string address, string gender, string toDay, string fromDay, string reasonAbsence)
        {
